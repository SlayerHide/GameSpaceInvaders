...
public class Jugador {
	...
	public boolean collidesWith(Proyectil projectile) {
		Rectangle playerRect = new Rectangle(x, y, anchura, altura);
		Rectangle projectileRect = new Rectangle(projectile.getX(), projectile.getY(), projectile.getAnchura(),
				projectile.getAltura());
